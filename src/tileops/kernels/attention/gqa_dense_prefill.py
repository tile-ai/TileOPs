...
def _gqa_prefill_dense_fwd_kernel(
    batch: int,
    heads: int,
    heads_kv: int,
    seq_len_q: int,
    ...
    def _gqa_prefill_dense_fwd_func(
...
@torch.library.custom_op("tileops::gqa_prefill_dense_fwd_wrapped_kernel", mutates_args=())
def _gqa_prefill_dense_fwd_wrapped_kernel(
    ...
    return _gqa_prefill_dense_fwd_kernel(
        batch,
        heads,
        heads_kv,
        seq_len_q,
...
class GQAPrefillDenseFwdKernel(DensePrefillKernel):
    ...
    def _build_program(self) -> None:
        self.kernel = _gqa_prefill_dense_fwd_kernel(
            self.batch,
            self.heads,
            self.heads_kv,
            self.max_seqlen_q,
