...
from tileops.kernels.flash_decode import GQADecodeKernel, GQADecodeSplitKVKernel, GQADecodeCombineKernel
...
class GroupQueryAttentionDecodeWithKVCacheOp(Op):
    ...
    def __init__(self,
        ...
        self.no_split_kernel = self.kernel_map["GQADecodeKernel"](
            batch, heads, heads_kv, seqlen_kv, dim, self.dtype, tune=tune)

        # Construct the split kernel
        self.split_kernel = self.kernel_map["GQADecodeSplitKVKernel"](
            batch, heads, heads_kv, seqlen_kv, dim, self.dtype, tune=tune)
        ...
        self.combine_kernel = self.kernel_map["GQADecodeCombineKernel"](
    ...
    def default_kernel_map(self) -> Dict[str, Kernel]:
        return {
            "GQADecodeKernel": GQADecodeKernel,
            "GQADecodeSplitKVKernel": GQADecodeSplitKVKernel,
            "GQADecodeCombineKernel": GQADecodeCombineKernel,
        }
