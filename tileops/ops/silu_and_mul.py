...
from tileops.kernels.activation import SiluAndMulKernel

from .op import Op

__all__ = ["SiluAndMulOp"]
...
class SiluAndMulOp(Op):
    ...
    def __init__(self,
        ...
        self.kernel = self.kernel_map["silu_and_mul_kernel"](
            m, self.padded_n, dtype, tune=tune)

    @property
    def default_kernel_map(self) -> Dict[str, Kernel]:
        return {"silu_and_mul_kernel": SiluAndMulKernel}
