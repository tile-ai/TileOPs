...
// Usage: ./hbm_saturation [size_mb]  (default: 2048)
...
int main(int argc, char* argv[]) {
    ...
    // CSV header
    printf("op,vec_width,block_size,access,align,best_ms,median_ms,best_gbs,median_gbs,pct_of_4800_best\n");

    auto print_row = [](const char* op, const char* vec, int bs, const char* access,
