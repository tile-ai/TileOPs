...
def test_moe_experts_nopad_bench(
    ...
    def _nopad_fn(hidden, w1, w2, topk_weights, topk_ids):
        nopad.forward(output, hidden, w1, w2, topk_weights, topk_ids, num_experts, None, ws1, ws2)
        return output
    ...
    def _padded_fn(hidden, w1, w2, topk_weights, topk_ids):
        padded.forward(output, hidden, w1, w2, topk_weights, topk_ids, num_experts, None, ws1, ws2)
        return output
