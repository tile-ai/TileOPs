...
- [ ] **Trust-layer scope.** Refactor stays within one trust layer per `docs/design/trust-model.md` (manifest / test / implementation / benchmark). Cross-layer touches are subject to strict-mode/principled-mode gating in `pre-review.md`.
