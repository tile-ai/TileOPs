→ [testing.md §Test case policy](../../docs/design/testing.md#test-case-policy) states which purposes a case may serve, the dtype and shape coverage rules, and what `scripts/test_node_delta.py` reports. [layer-boundaries.md §Test](../../docs/design/layer-boundaries.md#test) states the layer boundaries. What follows is what those leave open.
