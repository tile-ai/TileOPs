...
1. Create `tileops/kernels/reduction/vector_norm/__init__.py`:
   - Explicit `__all__ = ["VectorNormKernel"]` and `from .fwd import VectorNormKernel`
1. Create `tileops/ops/reduction/l1_norm.py`, `l2_norm.py`, `inf_norm.py`:
...
1. Create `tests/ops/test_vector_norm.py`:
...
1. Create `benchmarks/ops/bench_vector_norm.py`:
