...
| [manifest.md](manifest.md)                         | `tileops/manifest/` spec: signature, workloads, roofline fields, source.                                                                    |
...
| [roofline.md](roofline.md)                         | `tileops/manifest/` `roofline` field spec: performance model, authoring, and per-consumer contracts (validator, benchmark, M5, op codegen). |
