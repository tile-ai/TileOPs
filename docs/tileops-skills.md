...
| Resource                          | Writer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `tileops/manifest/`               | Three writers, disjoint slices. `add-manifest` writes reference-derivable fields (`signature.{inputs,outputs,params,shape_rules,dtype_combos}`, `roofline.{flops,bytes,vars}` for well-known ops); preserves `workloads`, `source.*`, `status`, `family`, `ref_api` verbatim if the entry exists, defaults otherwise. `fix-manifest` writes on-disk-derivable fields (`source.kernel_map`, `signature.static_dims`) on existing entries only. `align-op@FLIP_STATUS` writes only `status`. No other skill writes the manifest. |
| `tileops/ops/**` op files         | `scaffold-op` creates; `implement-op` edits.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `tileops/kernels/**` kernel files | No op-development skill writes kernels: `align-op --mode=redesign` surfaces mismatches via `kernel-check.json`, and a future `kernel-align` skill will own kernel-layer work. Workflow skills (`resolve-tileops`, `follow-up`) may commit kernel-file edits on the PR branch when triaging accepted review feedback — that path is reactive (review-driven), not authoritative.                                                                                                                                                |
| `tests/ops/**`                    | `test-op`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
