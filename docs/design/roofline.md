...
A composite op additionally declares `composition`, naming the stages its cost is made of. It is
orthogonal to the two modes and coexists with either; the field is specified in
[manifest.md § Roofline](manifest.md#roofline).
