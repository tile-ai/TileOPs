import argparse
from top.layers import NativeSparseAttentionForwardLayer
...
def test_nsa_op( 
    ...
    layer = NativeSparseAttentionForwardLayer(batch, heads, seq_len, dim, is_causal, scale, block_size, groups, selected_blocks, tune=tune)
