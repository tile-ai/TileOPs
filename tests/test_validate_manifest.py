...
class TestParamDomain:
    ...
    def test_what_is_not_a_type_expression_is_rejected(self, validator):
        """Unparsable text, and a YAML scalar that is not text at all."""
        for written in ("float |", None, 123):
...
class TestValidateDtypesParity:
    ...
    def test_optional_same_as_required_input_follows_each_combo(self, validator):
        """The optional-input example retains same_as identity per row."""
        import torch
