...
class FusedTopKFixture(FixtureBase):
    PARAMS = [
        ("num_tokens, num_experts, top_k, scoring_func, renormalize, dtype", [
            ...
            pytest.param(32,   128, 8, "softmax", False, torch.bfloat16, marks=pytest.mark.full, id="smoke-softmax-bf16"),
            pytest.param(32,   128, 8, "softmax", False, torch.float16,  marks=pytest.mark.full, id="smoke-softmax-fp16"),
