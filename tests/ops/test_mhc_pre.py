...
def test_mhc_pre_op(
    ...
    test_mhc_pre_op=ManifoldConstrainedHyperConnectionPreOp(batch, n_expand, c_x, dtype=torch.bfloat16)
    x_res, x_layer = test_mhc_pre_op.forward(phi, x, b, alpha_pre, alpha_post, alpha_res, sinkhorn_repeat)
    print(x_res)
    print(x_layer)
