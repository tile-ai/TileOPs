...
def test_moe_grouped_gemm_nopad_op(numel, num_experts, n, k, distribution, dtype):
    test = MoeGroupedGemmNopadWorkload(numel, num_experts, n, k, dtype, distribution=distribution)
