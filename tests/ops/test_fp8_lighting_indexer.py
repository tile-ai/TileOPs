...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=Optional[dict], default=None, help='positional encoding dim')
    parser.add_argument('--tune', action='store_true', default=False, help='enable autotune')
    args = parser.parse_args()

    test_indexer(args.seq_len, args.heads, args.index_dim, args.seq_len_kv,
