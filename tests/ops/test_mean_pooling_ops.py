...
@pytest.mark.parametrize(
    "batch_size, seq_len, heads, dim, chunk_size, chunks_per_bacth, seq_num, dtype, accum_dtype, tune",
    [
        (1, 8192, 64, 128, 64, 128, 1, torch.float16, torch.float32, False),
        (1, 8192, 64, 128, 64, 128, 1, torch.float16, torch.float32, True),
    ],
)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_offsets', type=int, default=0, help='not use offsets: 0, use offsets: 1')
    parser.add_argument('--dtype', type=str, default='float16', choices=['float16', 'bfloat16'], help='data type')
    parser.add_argument('--accum_dtype', type=str, default='float16', choices=['float32', 'bfloat32'], help='accumulation data type')
